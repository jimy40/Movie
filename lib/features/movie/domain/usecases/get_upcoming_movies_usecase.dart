...
class GetUpcomingMoviesUsecase extends BaseUsecase<List<MovieEntity>> {
  final BaseMovieRepositories baseMovieRepositories;

  GetUpcomingMoviesUsecase({required this.baseMovieRepositories});
  @override
  Future<Either<Failure, List<MovieEntity>>> call() =>
      baseMovieRepositories.getUpcomingMovies();
}

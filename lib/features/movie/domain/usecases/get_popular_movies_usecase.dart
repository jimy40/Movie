...
import 'package:movie_clean_arch_test/core/usecase/usecase.dart';
...
class GetPopularMoviesUsecase extends BaseUsecase<List<MovieEntity>> {
  ...
  GetPopularMoviesUsecase({required this.baseMovieRepositories});

  @override
  Future<Either<Failure, List<MovieEntity>>> call() {
    return baseMovieRepositories.getPopularMovies();
  }

  // Future<Either<Exception, List<MovieEntity>>> call() => baseMovieRepositories.getPopularMovies();
}
